    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Create New Cargo</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="salario" type="text" class="form-control" id="salario" placeholder="Salario">@error('salario') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
